...
- Updated the hero copy and terminal text to emphasize AppSec triage, BELIEF,
  PDX, and local-first security tooling.
- Added skills for reportability triage, static analysis, Semgrep, CodeQL,
  SARIF, and PDX deltas.
- Tightened the visual style with stronger cyber/security card treatments,
  badges, subtle technical corners, and clearer section hierarchy.
